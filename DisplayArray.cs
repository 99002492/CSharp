...
namespace ConsoleApp1
{
    ...
    class DisplayArray
    {
        ...
        static void InitializeComponent()
        {
            ...
            mgr.AddCustomer(new Customer { CustomerID = 01, CustomerName = "vidya", Address = "Mysore", Salary = 12000 });
            mgr.AddCustomer(new Customer { CustomerID = 02, CustomerName = "ram", Address = "Bangalore", Salary = 15000 });
            mgr.AddCustomer(new Customer { CustomerID = 03, CustomerName = "john", Address = "Mangalore", Salary = 13500 });
            mgr.AddCustomer(new Customer { CustomerID = 04, CustomerName = "nick", Address = "Mysore", Salary = 12800 });
        }
